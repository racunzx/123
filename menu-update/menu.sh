...
# VPN Premium Script
# © Github.com/XC0D3-X
# Orignal Repository: https://github.com/XC0D3-X/aws
# Modified By harithwyd
# Telegram: https://t.me/ harithwyd
...
echo -e  "  ╠════════════════════════════════════════════════════════════╣" | lolcat
echo -e  "  ║                 COPYRIGHT © 2021 XC0D3-X                   ║" | lolcat
echo -e  "  ║                     POWERED BY harithwyd                   ║" | lolcat
echo -e  "  ╚════════════════════════════════════════════════════════════╝" | lolcat
echo -e  "\e[1;31m"
