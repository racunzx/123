...
echo -e  "  ║      COPYRIGHT XC0D3-X, POWERED BY harithwyd.       ║" | lolcat
echo -e  "  ╚════════════════════════════════════════════════════════════╝" | lolcat
echo -e  "\e[1;31m"
...
case $system in
		...
		;;
		14)
		echo -e "\e[1;31m SORRY!!!! Still No Update , Sila semak repo https://github.com/XC0D3-X/aws masa kesemasa\e[0m "
		sleep 5
		clear
		system
		exit
