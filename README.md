<h2 align="center">AutoScript Install SSH & OpenVPN & V2rayXray & SSR & Trojan & WireGuard For Debian VPS By harithwyd <img src="https://img.shields.io/badge/Version-2.0.4-blue.svg"></h2>
...
wget https://raw.githubusercontent.com/XC0D3-X/aws/main/setup.sh
chmod +x setup.sh
./setup.sh
  ```
##    <img src="https://img.shields.io/badge/Install%20Hanya-SSH%2FSSH%20SSL(Stunnel)%20SSH--WS%20Python%20BadVPN--UDPGW-green">
   ...
   ```html
wget https://raw.githubusercontent.com/XC0D3-X/aws/main/install/sshonly.sh
chmod +x sshonly.sh  
./sshonly.sh
  ```
...
*   Modded Script by    t.me/harithwyd
	   ...
	   <img src="https://img.shields.io/badge/%20COPYRIGHT%20%C2%A9%202021-%20By%20harithwyd%20XC0D3-X%2C%20Inc-blue">
