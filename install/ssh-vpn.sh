...
echo "echo AutoScript by harithwyd" >> .profile
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/XC0D3-X/aws/main/nginx.conf"
mkdir -p /home/vps/public_html
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/${GitUser}/aws/main/lain2/TEST.html"
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/XC0D3-X/aws/main/vps.conf"
